    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    <a href="{{ url('/results') }}" data-testid="test-result" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">See test result</a>
                </div>
                ...
                <div class="mt-16">
                    ...
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <div class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Get a DNA test</h2>
                                <h3>It's easy and secure</h3>

                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    Get a DNA test, by just filling out the below fields.<br>
                                    You will receive a link to an invoice and when this is paid, you will receive the DNA test by mail.
                                </p>
                                ...
                                <form action="{{ action([\App\Http\Controllers\OrderController::class, 'store']) }}" method="post">
                                    ...
                                    <div class="mt-6">
                                        <div class="flex flex-col gap-2">
                                            <label for="name" class="text-sm text-gray-600 dark:text-gray-400">Choose a password</label>
                                    ...
                                    <!-- submit -->
                                    <div class="mt-6">
                                        <button type="submit" class="bg-red-500 hover:bg-red-600 text-white p-2 rounded-lg focus:outline focus:outline-2 focus:outline-red-500">Order now »</button>
                                    </div>
                                </form>
                            </div>
                        </div>
